...
<body>
    <div class="above-tab">
        ...
        <!-- ปุ่มบัญชีของฉัน -->
        <div class="pt7">
            <button class="big-button-or1" onclick="document.getElementById('logoutModal').style.display='flex'">
        ...
        <div id="logoutModal" class="logout-screen-overlay" style="display: none;">
            <div class="windowns">
                <div class="in-windowns">
                    <div class="content-for-windowns">คุณแน่ใจว่าจะออกจากระบบ ?</div>
                    <div class="double-buttons">
                        <a href="logout_admin_action.php"><button class="green-bt">ตกลง</button></a>
                        <button class="red-bt" onclick="document.getElementById('logoutModal').style.display='none'">ยกเลิก</button>
                    </div>
                </div>
            </div>
        </div>
